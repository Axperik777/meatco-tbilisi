...
const strings = {
  "ka": {
    ...
    "description": "ღორისა და საქონლის ხორცი, სუბპროდუქტები — საამქრო მეველეს ქ. 3-ში. შეკვეთით დავჭრით, წონას WhatsApp-ში შევათანხმებთ. მიტანა თბილისში ან თვითგატანა.",
    ...
    "control1Text": "დაამატეთ სასურველი ხორცი კალათაში, მიუთითეთ წონა და სია WhatsApp-ში გამოგვიგზავნეთ.",
    "control2Title": "ავწონით და შეგითანხმებთ",
    "control2Text": "შევამოწმებთ, რა გვაქვს, ავწონით და თანხასა და მიტანის დროს შეგითანხმებთ.",
    "control3Title": "მოგიტანთ ან თავად გაიტანეთ",
    "control3Text": "შეკვეთას კურიერი მოგიტანთ. თუ თავად გირჩევნიათ გატანა, საამქროში გელოდებით — მეველეს ქ. 3.",
    ...
    "serviceTitle": "როგორ შევუკვეთოთ ხორცი",
    ...
    "appHeroCopy": "შეკვეთით დავჭრით და ავწონით. ზუსტ წონასა და თანხას შეფუთვამდე WhatsApp-ში შეგითანხმებთ.",
    ...
    "helpIntro": "მწვადისთვის, ხინკლისთვის თუ სადილისთვის — ხორცის შერჩევაში დაგეხმარებით.",
    ...
    "slotTomorrow": "ხვალ",
    "slotNote": "აირჩიეთ თქვენთვის მოსახერხებელი დრო. მიტანის დროსა და საფასურს WhatsApp-ში შევათანხმებთ.",
    ...
    "preparationLabel": "როგორ დავჭრათ · სურვილისამებრ",
    "preparationPlaceholder": "სამწვადედ, ფარშად, ზედმეტი ცხიმის მოცილება…",
    ...
    "cartDirectNote": "WhatsApp-ში თქვენი სია გაიხსნება. გაგზავნეთ შეტყობინება — შეკვეთას მივიღებთ და დეტალებს დავაზუსტებთ.",
    "cartReplyNote": "10:00–18:00 საათებში 5–10 წუთში გიპასუხებთ. ზუსტ წონას შეფუთვამდე შეგითანხმებთ.",
  ...
  "ru": {
    ...
    "description": "Свинина, говядина и субпродукты из цеха на Мевеле, 3. Нарежем под заказ, согласуем вес в WhatsApp. Доставка по Тбилиси или самовывоз.",
    ...
    "control1Text": "Добавьте нужные части в корзину, укажите вес и отправьте список в WhatsApp.",
    "control2Title": "Взвесим и согласуем",
    "control2Text": "Проверим, что есть, взвесим и согласуем с вами сумму и время доставки.",
    "control3Title": "Курьер или самовывоз",
    "control3Text": "Курьер привезёт заказ. Если удобнее забрать самим — ждём в цехе на Мевеле, 3.",
    ...
    "serviceTitle": "Как заказать мясо",
    ...
    "appHeroCopy": "Нарежем, сколько нужно, и взвесим. Вес и сумму согласуем в WhatsApp до упаковки.",
    ...
    "helpTitle": "На связи",
    "helpIntro": "Для мцвади, хинкали или домашнего обеда — подскажем, какую часть взять.",
    ...
    "slotTomorrow": "Завтра",
    "slotNote": "Выберите, когда вам удобно. Время и стоимость доставки согласуем в WhatsApp.",
    ...
    "preparationLabel": "Как нарезать · необязательно",
    "preparationPlaceholder": "На мцвади, в фарш, убрать лишний жир…",
    ...
    "trustCut": "Отрежем, сколько нужно",
    "trustDirect": "Без лотка и без комиссии приложения",
    "trustPhoto": "Фото до упаковки — по запросу",
    ...
    "cartDirectNote": "В WhatsApp откроется ваш список. Нажмите «Отправить» — получим заказ и уточним детали.",
    "cartReplyNote": "Ответим за 5–10 минут с 10:00 до 18:00. Точный вес согласуем с вами до упаковки.",
  ...
  "en": {
    ...
    "description": "Pork, beef and offal from our butcher’s workshop at 3 Mevele Street. Cut to order, weight agreed on WhatsApp. Tbilisi delivery or pickup.",
    ...
    "control1Text": "Add your cuts, choose the weight and send us the list on WhatsApp.",
    "control2Title": "We weigh and confirm",
    "control2Text": "We’ll check what’s available, weigh your meat and agree the total and delivery time with you.",
    "control3Title": "Delivery or pickup",
    "control3Text": "Our courier brings your order. Prefer to collect? Come to our workshop at 3 Mevele Street.",
    ...
    "appHeroCopy": "We’ll cut the amount you need, then weigh it. Exact weight and total agreed on WhatsApp before packing.",
    ...
    "helpIntro": "For mtsvadi, khinkali or dinner at home — we’ll help you choose the right cut.",
    ...
    "slotNote": "Choose a time that suits you. We’ll agree the delivery time and cost on WhatsApp.",
    ...
    "preparationLabel": "How to cut it · optional",
    "preparationPlaceholder": "For mtsvadi, mince it, trim excess fat…",
    ...
    "homePickup": "Courier or pickup · butcher’s workshop, 3 Mevele St",
    "homeMinimum": "min {amount}",
    "trustCut": "Cut the amount you need",
    "trustDirect": "No fixed tray, no app commission",
    "trustPhoto": "Photo before packing, on request",
    ...
    "cartDirectNote": "Your list will open in WhatsApp. Tap Send — we’ll receive your order and confirm the details.",
    "cartReplyNote": "We reply in 5–10 minutes from 10:00 to 18:00. We’ll agree the exact weight with you before packing.",
