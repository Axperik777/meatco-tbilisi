...
const strings = {
  "ka": {
    ...
    "appHeroCopy": "დღეს დაგიჭრით რამდენიც გინდათ. ზუსტ წონას და თანხას WhatsApp-ში გეტყვით.",
    ...
    "helpIntro": "მოგვწერეთ ან დაგვირეკეთ — გირჩევთ, რა აიღოთ, და მოგიტანთ.",
    ...
    "minimumRemaining": "დაამატეთ კიდევ რამე. შეკვეთა {minimum}-დან.",
  ...
  "ru": {
    ...
    "appHeroCopy": "Сегодня нарежем сколько нужно. Точный вес и сумму напишем в WhatsApp.",
    ...
    "helpTitle": "На связи",
    "helpIntro": "Напишите или позвоните — подскажем, что взять, и привезём.",
    ...
    "minimumRemaining": "Добавьте ещё что-то. Заказ от {minimum}.",
  ...
  "en": {
    ...
    "appHeroCopy": "We cut the weight you need today. We’ll tell you the exact weight and total on WhatsApp.",
    ...
    "minimumRemaining": "Add a bit more. Orders start from {minimum}.",
